...
### Assess KBEP knowledge-base extraction protocol

Adopt the parked KBEP handoff as a local assessment, not as an accepted protocol: determine whether a portable extraction contract is needed, its relationship to the existing Knowledge Export Package proposal and specification, and the appropriate KIP/KIS route if it is.
...
Adopt the parked KBIP handoff as a local assessment, not as an accepted protocol: determine whether governed ingress is a portable normative concern, how it relates to extraction, and whether it warrants a separately scoped KIP/KIS after the KBEP assessment.
